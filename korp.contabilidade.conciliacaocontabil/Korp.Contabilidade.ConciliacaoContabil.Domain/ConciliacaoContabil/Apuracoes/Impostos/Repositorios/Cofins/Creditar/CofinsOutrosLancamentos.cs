...
public class CofinsOutrosLancamentos: ICofinsCreditarRepositorio
{
    ...
    public CofinsOutrosLancamentos(IRepository<CabecalhoOutrosLancamentosFiscais> cabecalhoOutrosLancamentos, IRepository<OutrosLancamentosFiscais> lancamentosFiscais)
    {
    ...
    public async Task<IReadOnlyCollection<IImpostoDto>> ListarImpostoCreditar(ConciliacaoContabil conciliacaoContabil)
    {
        ...
        var outrosNotaEntradaEntrada = from l in lancamentoFiscais
            ...
            where l.Imposto == "COFINS" && l.CreditoDebito == "C" &&
