...
function findEnvironmentTsFiles() {
    let environmentDevEnvFiles = glob.sync(workspacePath + '/src/**/environment.dev-env.ts');
    return environmentDevEnvFiles;
}

function findAppSettingsFiles() {
    let appSettingsDevEnvFiles = glob.sync(workspacePath + '/src/**/appsettings.dev-env.json');
